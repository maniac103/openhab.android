...
public class ActivityControllerOnePane extends ActivityController {
    public ActivityControllerOnePane(OpenHABMainActivity activity) {
        super(activity);
    }
    ...
    protected void updateFragmentState(FragmentUpdateReason reason) {
        ...
        Fragment fragment = mPageStack.empty()
                ? mSitemapFragment
                : mPageStack.peek().second;
        if (fragment != null) {
